...
//
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {  //もし送信ボタンが押されたら
        ...
        $form_member_id = $form['member_id'];
        $form_member_id = (int) $form_member_id;
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <dl>
                ...
                <dd>
                    ...
                    <?php endif;?>
                    <?php if (isset($error['donotlen']) and $error['donotlen'] === 'donotlen'):?>
